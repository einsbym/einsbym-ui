    ...
    return (
        <>
            ...
            <div
                ...
                className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto ${isSidebarActive ? null : '-translate-x-full'} transition-transform bg-white dark:bg-gray-800`}
