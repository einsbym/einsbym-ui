...
import { UPDATE_COVER_IMAGE, UPDATE_PROFILE_IMAGE } from '@/graphql/mutations/user';
...
interface UpdateCoverImageModalProps {
    userId: string;
    isChangeCoverImageModalActive: boolean;
    setIsChangeCoverImageModalActive: Dispatch<SetStateAction<boolean>>;
}

export default function UpdateCoverImageModal(props: UpdateCoverImageModalProps) {
    ...
    const handleSave = async () => {
        try {
            ...
            if (errors) {
                throw new Error('Error when attempting update the cover image');
            }
            ...
            props.setIsChangeCoverImageModalActive(false);
        } catch (error) {
    ...
    return (
        <div
            id="default-modal"
            className={`${
                !props.isChangeCoverImageModalActive ? 'hidden' : null
            ...
            <div className="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div className="relative rounded-lg shadow bg-gray-700">
                    ...
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-600">
                        <h3 className="text-xl font-semibold text-white">Update your cover image</h3>
                        <button
                            type="button"
                            ...
                            onClick={() => props.setIsChangeCoverImageModalActive(false)}
                        >
                            <svg
                                className="w-3 h-3"
                                aria-hidden="true"
                    ...
                    <p className='mt-2 text-white text-center'>Select an image file from your device and click in <b>save</b> to update your cover.</p>
